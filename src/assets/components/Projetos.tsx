        ...
        <ProjetoStyle>
            <div className="layer">
                <div className="content">
                    <img src={props.src ?? "/mockups/default.png"} alt="" />
                </div>
            </div>
            <nav>
                <div>
        ...
        <StyleProjects tema={temas} id="projetos">
            ...
            <div>
                <div className="conteiner">
                    <Projeto src="/mockups/MOCKUPS (1).png" linkDoDeploy="https://expo.dev/accounts/vee-dev/projects/super_hat/builds/866a499f-622a-4b76-acdd-a716589b8454" linkDoProjeto="https://github.com/veetorio/Beary-App" tipoDoProjeto={TipoProjeto.MOBILE} name="Beary"></Projeto>
                    <Projeto src="/mockups/pollen.png" linkDoProjeto="https://github.com/veetorio/pollen-api" tipoDoProjeto={TipoProjeto.BACKEND} name="Pollen API"></Projeto>
